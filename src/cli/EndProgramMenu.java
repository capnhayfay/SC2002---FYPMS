...
public class EndProgramMenu implements Menu {
    /**
     * Default constructor for EndProgramMenu
     */
    public EndProgramMenu() {

    }

    /**
     * This method displays a goodbye message to the user on the console, thanking
     * them for using src.FYPMS and wishing them a nice day.
     */
    public void display() {
        System.out.println();
        System.out.println("Thank you for using src.FYPMS. Have a nice day!");
        System.out.println();
        System.out.println("=========================================");
    }
}
