...
public class FYP {
    ...
    private List<String> requestorList;
     ...
     * @param requestorList    The list of students who have requested the project.
     * @param statusChangeDate The date of the last change of the project status. The first date is constant.
     * @param deadline The submission deadline of the project
     */
    public FYP(String supervisorName, String title, FYPStatus status, String studentName, List<String> requestorList, LocalDateTime statusChangeDate, LocalDateTime deadline) {
    ...
    public List<String> getRequestorList() {
    ...
    public void printFYPDetails() {
        String commaSeparatedRequestors = String.join(", ", requestorList);
        System.out.println();
